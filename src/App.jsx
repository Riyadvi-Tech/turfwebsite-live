...
function App() {
  ...
  const replaceNavigationLogo = (event) => {
    ...
    if (adminBranding?.length) {
      ...
      style.textContent = '.vlogo .admin-brand-wrap{display:flex;align-items:center;justify-content:flex-start;width:100%}.vlogo .admin-brand-logo{width:72px;height:auto;display:block;flex-shrink:0}.vlogo .admin-tagline-logo{width:190px;height:auto;display:block}.side-head .admin-brand-wrap{display:flex;align-items:center;justify-content:center;width:100%}.side-head .admin-brand-logo{width:58px;height:auto;display:block;flex-shrink:0}.side-head .admin-tagline-logo{width:180px;height:auto;display:block}.sidebar.collapsed .side-head .admin-brand-wrap{gap:0}.sidebar.collapsed .side-head .admin-tagline-logo{display:none}.login-card .login-brand-logo{width:58px;height:auto;display:block;flex-shrink:0}.login-card .login-brand-wrap{display:flex;align-items:center;justify-content:center;width:100%;margin-bottom:20px}.login-card .login-brand-wrap img{max-width:560px;width:100%;height:auto;display:block}.login-card .login-tagline-logo{width:560px;height:auto;display:block}.side-foot .admin-profile{display:flex;align-items:center;gap:10px;width:100%;padding:6px 10px;border:1px solid rgba(57,255,122,0.12);border-radius:28px;background:rgba(255,255,255,0.025)}.side-foot .admin-profile-avatar{width:34px;height:34px;padding:0;border-radius:50%;object-fit:contain;display:block;flex-shrink:0}.side-foot .admin-profile-email{font-size:12px;color:var(--muted);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.sidebar.collapsed .side-foot .admin-profile{justify-content:center;padding:6px}.sidebar.collapsed .side-foot .admin-profile-email{display:none}.@media (max-width:1000px){.login-card .login-brand-wrap{margin-top:-6px;margin-bottom:12px}.login-card .login-brand-wrap img{max-width:214px;width:100%;height:auto}}'
